...
public class ESECalendarTests extends UnitTest {
	...
	public void shouldAddEvent() {
		...
		cal1.addEvent("Testevent2", cal1, "15.04.2011 13:40", "16.04.2011 13:00", false);
		assertEquals(2, cal1.getAllEvents().size());
		assertEquals(1, cal1.getAllPublicEvents().size());

		cal2.addEvent("Testevent3", cal1, "17.04.2011 13:40", "18.04.2011 13:00", false);
	...
	public void shouldGetAllEvents() {
		cal1.addEvent("Testevent1", cal1, "13.04.2011 13:40", "14.04.2011 13:00", true);
		cal1.addEvent("Testevent2", cal1, "15.04.2011 13:40", "16.04.2011 13:00", false);
		cal1.addEvent("Testevent3", cal1, "17.04.2011 13:40", "18.04.2011 13:00", false);

		assertEquals(1, cal1.getAllPublicEvents().size());
		assertEquals(3, cal1.getAllEvents().size());

		assertTrue(cal1.getAllEvents().get(0).getEventName().equals("Testevent1"));
		assertTrue(cal1.getAllEvents().get(1).getEventName().equals("Testevent2"));
		assertTrue(cal1.getAllEvents().get(2).getEventName().equals("Testevent3"));
	...
	public void shouldGetAllPublicEvents() {
		...
		assertTrue(cal1.getAllPublicEvents().get(0).getEventName().equals("Testevent1"));
	}
