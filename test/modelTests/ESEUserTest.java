...
public class ESEUserTest extends UnitTest {
	...
	public void shouldRemoveCalendarNewUser() {
		...
		ESECalendar husi = ESECalendar.find("byCalendarNameAndOwner",
				"Hausaufgaben", hansi).first();
		ESECalendar shop = ESECalendar.find("byCalendarName", "Shopping Liste")
				.first();
		assertNotNull(husi);
		assertNotNull(shop);
	...
	public void shouldRemoveCalendarDBUser() {
		...
		ESECalendar cal1 = ESECalendar
				.find("byCalendarName", "BobsCalendarOne").first();
		ESECalendar cal2 = ESECalendar
				.find("byCalendarName", "BobsCalendarTwo").first();
		ESECalendar cal3 = ESECalendar.find("byCalendarName",
				"BobsCalendarThree").first();
	...
	public void shouldNotRemoveSomebodyElsesFriendGroup() {
		ESEUser hansi = ESEFactory.createUser("hansi", "sehrgeheim", "Hans",
				"Müller");
		ESEUser hansi2 = ESEFactory.createUser("hansi2", "sehrgeheim", "Hans",
				"Müller");
